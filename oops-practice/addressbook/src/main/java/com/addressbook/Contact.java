...
public class Contact {
    ...
    // Constructor required for the test case
    public Contact(String fname, String lname, String city, String phone) {
        this(fname, lname, null, city, null, null, phone, null);
    }
